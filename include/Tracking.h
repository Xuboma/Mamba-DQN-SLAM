...
public:
    ...
    cv::Mat GrabImageMonocular(const cv::Mat &im, const double &timestamp, string filename, double &scaleFactors, int &nlevelss, float &nartioo);
...
protected:
    ...
    bool TrackWithMotionModel(float nartioo);
